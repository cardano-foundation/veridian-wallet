...
describe("AppWrapper - currentProfile logic", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });

  test("sets currentProfile to the oldest identifier if no default profile is set", async () => {
    ...
    expect(currentProfile.currentProfile).toBe("id-1");
  });
});
