...
export enum PrivacyPolicy {
  ...
  Section1Content1 = "The controller of the data processing described in this Privacy Policy is Cardano Foundation, unless we inform you otherwise in certain cases. You can notify Us of any data protection-related concerns using the following contact details:\n\nCardano Foundation\nDammstrasse 16\n6300 Zug\ngdpr@cardanofoundation.org",
  Section2Content1 = "For the Identity Wallet, We collect and manage data differently, aligning with our commitment to user privacy and secure identity management. We do not collect typical personal data like names, addresses, or contact information.\n\nWhen using the Products, the Foundation may ask you to provide certain information that can be used to identify or contact you (“Personal Data”). The types of Personal Data that We collect from you depend on the circumstances of collection, the nature of the Product used or the transaction undertaken.\n\nData We collect may include, but is not limited to:",
  ...
  Section7Content2 = "Data warehouses;",
  Section7Content3 = "IT service providers;",
  Section7Content4 = "Data analytics and/or marketing agencies;",
  Section7Content5 = "Third party service providers, tools or plugins that enable a better user experience for Products, such as social media plugins or online marketing tools, newsletter providers",
  Section7Content6 = "Auditors",
  Section7Content7 = "We shall take practical steps to ensure that their employees, officers, agents, consultants, contractors and such other third parties mentioned above who are involved in the collection or processing of your Personal Data will observe and adhere to the terms of this Privacy Policy and GDPR requirements.\n\nThe Foundation may disclose your Personal Data in good faith belief that such disclosure is necessary for one of the following reasons: complying with a legal obligation; protecting and defending the rights or property of the Foundation; preventing or investigating possible wrongdoing in connection with the Products; protecting the personal safety of users of Products or the public; protecting against legal liability; or responding to legal bodies as permitted or required by law such as in compliance with a warrant or subpoena issued by a court of competent jurisdiction; and/or responding to regulatory authorities.\n\nIn addition to the above, your Personal Data may also be disclosed or transferred to Our affiliates and subsidiaries.",
  Section8Title = "8. Your Rights",
  Section8Content1 = "Users can access, manage, and delete their Digital Identity Data within the wallet at any time. Any Private Key Material or other data securely stored within your device (as described in section 2) must be removed manually by the user.\n\nIf you want to know what Personal Data the Foundation holds about you or wish for it to be deleted, please reach out to Us at privacy@cardanofoundation.org.\n\nIn certain circumstances, you possess these data protection rights:",
  Section8Content2 = "Access: You can ask for details about your personal data We have.",
  Section8Content3 = "Rectification: If the data is inaccurate or incomplete, you can request corrections.",
  Section8Content4 = "Objection: You can contest the use of your data for specific reasons; for instance, using the unsubscribe option in our emails.",
  Section8Content5 = "Restriction: You can ask Us to limit the processing of your data.",
  Section8Content6 = "Data Portability: Request a copy of your data from Us in a standard, machine-readable format.",
  Section8Content7 = "Withdraw Consent: Should We process data based on your consent, you can retract it anytime.",
  Section8Content8 = "Please understand We might ask you to confirm your identity before acting on these requests. If unsatisfied with how We handle your data, you can report to your local Data Protection Authority in the EU or EEA.",
...
export enum TermsOfUse {
  ...
  Section1Subtitle4 = "d. Privacy Policy:",
  Section1Subtitle5 = "e. Feedback:",
  Section1Subtitle6 = "f. Dispute Resolution:",
  ...
  // eslint-disable-next-line @typescript-eslint/no-duplicate-enum-values
  Section2Subtitle7 = "-",
  Section2Subtitle8 = "e. Your Responsibility:",
