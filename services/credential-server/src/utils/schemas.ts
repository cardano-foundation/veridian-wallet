        ...
        oneOf: [
          { description: "Attributes block SAID", type: "string" },
          {
            ...
            properties: {
              ...
              email: { description: "Internal email of the employee", type: "string" },
              firstName: { description: "First name of the employee", type: "string" },
              lastName: { description: "Last name of the employee", type: "string" },
            },
            additionalProperties: false,
            required: ["i", "dt", "email", "firstName", "lastName"],
          },
        ],
      },
    },
